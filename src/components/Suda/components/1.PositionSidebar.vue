        ...
        <nav id="sidebar">
            <div :class="{active: toggle}" class=" sidebar2 sidebar-header">
                ...
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-primary"><i class="fab fa-searchengin"></i> Найти</button>
                    <button type="button" class="btn btn-secondary"><i class="fas fa-broom"></i> Сбросить</button>
                </div>
            </div> 
    
            <div class="ship-sidebar">
                <div>
                    <accordeons :class="{active: toggle}"></accordeons> 
                    <accordeons :class="{active: toggle}"></accordeons>
                </div>
                <div @click="sidebarCollapse" :class="{active: toggle}" class="sidebarCollapseDiv">
                    <span class="sidebarCollapse">
                            <span :class="{left: toggle,right: !toggle}">
                                <i  style="color:green" class="fas fa-angle-double-left"></i>
                            </span>
                    </span>
                </div>
            </div>
...
<script>
import accordeons from "./1.Accordeons";
